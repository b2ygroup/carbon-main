// lib/models/vehicle_type_enum.dart
import 'package:flutter/material.dart';

enum VehicleType {
  carGasolineSmall, carGasolineMedium, carGasolineLarge,
  carFlexSmall, carFlexMedium, carFlexLarge,
  carElectricCompact, carElectricSedanSuv, carHybrid,
  suvGasoline, suvDiesel, suvFlex, suvHybrid, suvElectric,
  pickupDiesel,
  motoGasolineLowCc, motoGasolineHighCc, motoElectric,
  busDieselUrban, busDieselRoad, busElectric,
  lightTruckDiesel, heavyTruckDiesel,
  airplaneSingleProp, airplaneRegionalJet, airplaneJumboJet,
  boatRecreational, boatYachtDiesel,
  gasoline, alcohol, diesel, flex, electric, gnv,
}
